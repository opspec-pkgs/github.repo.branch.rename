[![build](https://github.com/opspec-pkgs/github.repo.branch.rename/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/github.repo.branch.rename/actions/workflows/build.yml)
